...
export default async function handler(
  ...
  /**
   * The challenge string must be rotated and unpredictable, then if anybody gets hold of the signed message (sent to /log-in in this demo) it cannot be used to log in again once the challenge is rotated. Currently this is the responsibility of the developer implementing the server side of PolkaSignIn.
   *
